...
Tentative Thesis Title: \emph{Reliable and Sustainable Design for Digital Economic Platforms} 
...
fields, which are also the topics I am most actively working on:
...
Mechanism for Blockchain Transaction Fee Allocation''} \M4A~\href{https://arxiv.org/abs/2209.13099}{[Link]}
...
and Motion Estimation} \EAI~\href{http://wiku30.xyz/2019/5594.pdf}{[Link]}
...
\textbf{Proof-of-Learning with Incentive Security} \M4A \SUS
...
\textbf{Peer Prediction for Verifier's Dilemma} \M4A

\emph{(an interest-driven project, collaborators TBA)}
