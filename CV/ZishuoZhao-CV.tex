...
On a very high level, my (starry-eyed) dream for research lies in the following 
two fields, which are also the topics I am most actively working on:
...
\begin{itemize}
    ...
    reinforce the efficiency and security of AI systems.
\end{itemize}

Additionally, I was interested in geometry-based computer graphics and vision at
...
embodied AI\EAI
%, and open to possible future interdisciplinary collaboration after my graduation
.
...
\iA4M\textbf{Personalized Pricing with Group Fairness Constraint} \href{https://dl.acm.org/doi/10.1145/3593013.3594097}{[Link]}
...
\iM4A\textbf{Bayesian Mechanism Design for Blockchain Transaction Fee Allocation}\footnote{A preliminary version of this research has the title ``Bayesian-Nash-Incentive-Compatible
...
\iA4M\textbf{Dynamic Car Dispatching and Pricing: Revenue and Fairness
...
\iEAI\textbf{ClusterSLAM: A SLAM Backend for Simultaneous Rigid Body Clustering
...
\iM4A\textbf{Proof-of-Learning with Incentive Security}
...
\iA4M\textbf{Incentive-Aware Dynamic Auction for Budgeted Bidders}

David Simchi-Levi{*}, \uline{Zishuo Zhao}{*}, Yuan Zhou{*}. (alphabetical order)

\medskip{}

\iM4A\textbf{Peer Prediction for Verifier's Dilemma}
