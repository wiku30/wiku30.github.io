...
mechanism design based on statistical/online learning, and topics in cryptography and distributed systems with applications in blockchain.
...
\textbf{Personalized Pricing with Group Fairness Constraint} \href{https://dl.acm.org/doi/10.1145/3593013.3594097}{[Link]}
...
\textbf{Proof-of-Learning with Incentive Security}
...
\textbf{Incentive-Aware Dynamic Auction for Budgeted Bidders}
...
\begin{itemize}
    \item Finalist Award in the ``一盏茶时 (\textit{IIIS Tea Time})'' photography exhibition for the 12th Anniversary of IIIS, Tsinghua University. 
...
\begin{itemize}
\item I have an amateur interest in Capture-The-Flag (CTF) competitions, and developed two Reverse challenges in the TQLCTF 2022.
\item I have a wide scope of hobbies in arts and aerobic sports, especially in vocal music, photography, piano, table tennis and orienteering. Particularly, my photographs ``梦影(\textit{Dreamland Impression})'' and ``$2\pi i$'' won the Finalist Award in the photography exhibition for the 12th Anniversary of IIIS, Tsinghua University in 2023.
\end{itemize}
