...
%    \item I use both pronouns of \emph{they/them} and \emph{he/him}. I \emph{slightly} prefer the former for a stereotype-free self-cognition; however, I am also fully comfortable with the latter in traditional usage as I am gender-conforming.
%\end{itemize}



\begin{flushright}
\emph{(Updated on Sep 18, 2025)}
\par\end{flushright}
\end{document}
