...
I have a special interest in the mechanism design for blockchain and decentralized AI, with a \textcolor[rgb]{0.5,0.5,1}{(starry-eyed) dream}~\iDM on the exploration of the design and theoretical boundaries of \textbf{decentralized trustworthy AI} platforms, including (particularly) the current concern and initiative of \textbf{AI safety} for the upcoming AGI era.
