...
\paper{Proof-of-Learning with Incentive Security} \href{https://arxiv.org/abs/2404.09005}{[Link]}

\uline{Zishuo Zhao}, Zhixuan Fang, Xuechao Wang, Xi Chen, Hongxu Su, Haibo Xiao, Yuan Zhou.

\emph{In Submission (2025).}
...
\paper{It Takes Two: A Peer-Prediction Solution for Blockchain Verifier's Dilemma} \href{https://arxiv.org/abs/2406.01794}{[Link]}
...
\begin{itemize}
    %\item My life philosophy is ``君子豹变，其文蔚也'', from 《周易》\emph{(The Book of Changes)}.
    \item I play some video games with the game ID \emph{Ai no Hime}, which simuitaneously refers to the advancement of artificial intelligence and my wish for an affectionate lifestyle.
    \item I use both pronouns of \emph{he/him/his} and \emph{they/them/their}. I \emph{slightly} prefer the latter for a stereotype-free self-cognition; however, I am also fully comfortable with the former in traditional usage as I am gender-conforming.
\end{itemize}
\fi


\begin{flushright}
\emph{(Updated on Jul 27, 2025)}
\par\end{flushright}
\end{document}
